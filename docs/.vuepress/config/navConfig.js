    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                text: '学习笔记',
                items: [
                    {text: '《JavaScript教程》07.笔记', link: '/pages/javascript/'},
                    {text: '《ES6 教程》07.笔记', link: '/pages/es6/'},
                    {text: '《Vue》07.笔记', link: '/pages/vue/'},
                    {text: '《TypeScript 从零实现 axios》', link: '/pages/typescript-axios/'},
                    {text: '小程序笔记', link: '/pages/wx-miniprogram/'},
                ]
            }
        ]
    },
